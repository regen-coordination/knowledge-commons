...
| `skills/non-actionable/geo-query` | `.agents/skills/non-actionable/geo-read/` | GraphQL queries, performance rules, canonical IDs; v0.2.9 adds space-scoped entity values/relations (`f5b443f1`). Upstream's Root default is adapted to this repo's Knowledge Commons default. |
